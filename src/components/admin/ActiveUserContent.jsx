                                ...
                                <table className="w-full min-w-[540px]" data-tab-for="order">
                                    <thead>
                                        <tr className="font-bold">
                                            ...
                                            <th className="text-[12px] tracking-wide py-2 px-4 bg-abu rounded-tr-md">Role</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="py-2 px-4 border-y-[3px] bg-white1 border-y-stroke">
                                                <span className="text-[13px] font-medium">Frontend
                                                    UI/UX Designer
                                        ...
                                        <tr>
                                            ...
                                            <td className="py-2 px-4 border-y-[3px] bg-white1 border-y-stroke">
                                                <span className="text-[13px] font-medium">Backend
                                                    Project Manager
                                                    Mobile Developer</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="py-2 px-4 border-y-[3px] bg-white1 rounded-be-md border-y-stroke">
                                                <span className="text-[13px] font-medium">UI/UX Designer
                                                    Frontend
                                                    Backend</span>
                                            </td>
                                        </tr>
