                ...
                <div className="mx-auto">
                  <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                      <h1 className="text-base font-semibold leading-6 text-active">
                        Project Role
                      </h1>
                    ...
                    <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                      <button
                        type="button"
                        className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-active shadow-sm ring-1 ring-inset ring-active hover:bg-gray-100"
                      >
                        Approve
                      </button>
                    </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex justify-end gap-6 pt-5">
                    <a href="/admin/handle-application/handle-application">
                      <button
                        type="button"
                        className="rounded-full bg-active px-6 py-2.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset  hover:bg-secondary"
                      >
                        Save
                      </button>
                    </a>
