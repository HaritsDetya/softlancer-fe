                    ...
                    <div class="w-full lg:w-auto">
                        <div class="bg-paper-patern flex flex-wrap rounded-lg">
                            <div class="lg:flex items-center mx-5 my-5">
                                <Image src="/images/company_1.png" alt="company_1" class="justify-between w-40 lg:w-1/2" width={1} height={0} />
                                <div class="px-3">
                                    ...
                                    <div class="flex flex-wrap items-center">
                                        <img src="/images/office-building.svg" alt="office-building" />
