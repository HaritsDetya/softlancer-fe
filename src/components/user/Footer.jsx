  ...
  return (
    <footer className="pt-24 bg-gradient-to-b from-primary to-background">
        ...
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-12">
            <img
              ...
              alt="footer_img"
              className="rounded-lg shadow-md shadow-slate-400"
            />
            <img src="/images/logoSoftLancer.svg" alt="logoSoftlancer" className="h-10 my-4" />
            <p className="text-active text-sm">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe dicta minus libero
              labore cum ducimus modi fugit aperiam ratione tenetur.
            </p>
      ...
      <nav className="block bg-accent1 w-full mt-5">
        <p className="text-sm font-semibold px-12 py-6 text-active">
          © 2024 Software Engineering. All Right Reserved{" "}
        </p>
      </nav>
    </footer>
  );
